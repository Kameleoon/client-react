...
* Fixed a bug where [Conversions](https://developers.kameleoon.com/feature-management-and-experimentation/web-sdks/react-js-sdk#conversion) could be erroneously counted twice in specific scenarios.
